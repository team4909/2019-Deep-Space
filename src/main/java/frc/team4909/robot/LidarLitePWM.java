...
public class LidarLitePWM {
	 ...
	 */
	private static final int CALIBRATION_OFFSET = -18; // Need to calibrate for our robot - make sure to account for
														// bumper width
	...
	public LidarLitePWM(int source) {
		...
		counter.setMaxPeriod(10); // Different value may need to be set
